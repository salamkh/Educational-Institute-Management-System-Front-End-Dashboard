...
const GIFT = ({ setTitle }) => {
    ...
    const url_add = "http://127.0.0.1:8000/api/add_reward";
    const url_edit = "http://127.0.0.1:8000/api/update_reward/";
    const url_oneUser = "http://127.0.0.1:8000/api/user_rewards/";
    ...
    const handleEdit = (item) => {
        ...
        setBalanceDate(item.advance.rewarddDate);
    ...
    const submit = (e) => {
        ...
        formData.append('rewarddDate', balance_date);
    ...
    const update = (e) => {
        ...
        axios.patch(url_edit + oneUser.advance.rrId, formData, { headers: { authorization: "Bearer " + user.accessToken }, })
            .then((response) => {
                console.log("response:", response.data.message);
                console.log(response);
                setMsg(response.data.message);
            ...
            <div className={classes.header}>
                <Grid container spacing={2}>
                    ...
                    <Grid  item xs={11} md={4} lg={4}>
                        <div className={classes.addIconButton} style={{ marginRight: "0" }}>
                            ...
                            <span style={{ color: "#333", fontSize: "20px" }}>  البحث عن المكافئات الخاصة بمستخدم </span>
                ...
                <div style={{ display: "flex" }}>
                    ...
                    <div className={classes.addIconButton} >
                        ...
                        <Tooltip title="إضافة مكافأة" area-label="add" >

                            <button onClick={() => setOpen(true)} className="newButton">إضافة مكافأة</button>
                        ...
                        <Grid container style={{ marginTop: "60px" }}>
                            ...
                            <Grid item md={6} lg={6}>
                                ...
                                >
                                    ...
                                    <MenuItem value={"مصروفة"} >مصروفة</MenuItem>
                                    <MenuItem value={"غير مصروفة"} >غير مصروفة</MenuItem>
