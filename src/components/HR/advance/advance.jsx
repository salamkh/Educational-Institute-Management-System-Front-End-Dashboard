...
const Advance = ({ setTitle }) => {
    const classes = useStyles();
    let newDate = new Date();
    let date = newDate.getFullYear() + '-' + (newDate.getMonth() + 1) + '-' + newDate.getDate();
    const url_add = "http://127.0.0.1:8000/api/add_advance";
    const url_edit = "http://127.0.0.1:8000/api/update_advance/";
    const url_oneUser = "http://127.0.0.1:8000/api/user_advances/";
    const url_range = "http://127.0.0.1:8000/api/range_advances";
    ...
    const handleEdit = (item) => {
        setUser(item);
        setName(item.advance.userName)
        setBalance(item.advance.balance);
        setCause(item.advance.cause);
        setBalanceDate(item.advance.advancedDate);
    ...
    const submit = (e) => {
        ...
        formData.append('advancedDate', balance_date);
    ...
    const update = (e) => {
        ...
        axios.patch(url_edit + oneUser.advance.advId, formData, { headers: { authorization: "Bearer " + user.accessToken }, })
            .then((response) => {
                console.log("response:", response.data.message);
                console.log(response);
                setMsg(response.data.message);
        ...
        <Container className={classes.container}>
            <div className={classes.header}>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={11} md={4} lg={4}>
                        <div className={classes.addIconButton} style={{ marginRight: "0" }}>
                            ...
                            <span style={{ color: "#333", fontSize: "20px" }}>  البحث عن السلف الخاصة بمستخدم </span>
                ...
                <div style={{ display: "flex" }}>
                    ...
                    <div className={classes.addIconButton}>
                        ...
                        <Tooltip title="إضافة سلفة" area-label="add" >

                            <button onClick={() => setOpen(true)} className="newButton">إضافة سلفة</button>
                    ...
                    <div className={classes.addIconButton} style={{ marginRight: "1%" }}>
                        ...
                        <Tooltip title="طباعة تقرير " area-label="add" >
                            ...
                            <button onClick={() => printReport()} className="newButton">طباعة التقرير</button>
            ...
            <Modal open={open} >
                <Container className={classes.modal}>
                    <form action="" >
                        <Grid container span={2} style={{ marginTop: "60px" }}>
                            <Grid item md={6} lg={6}>
                            ...
                            <Grid item md={6} lg={6}>
                                ...
                                >
                                    ...
                                    <MenuItem value={"مستردة"}>مستردة</MenuItem>
                        ...
                        {oneUser &&
                            <>
                                <Grid container style={{ marginTop: "60px" }}>
                                    ...
                                    <Grid item md={6} lg={6}>
                                        <div className="label_user_div"> <span style={{ color: "#333", fontSize: "20px", marginRight: "60px" }}>الحالة</span></div>
            ...
            <Modal open={openSearch} >
                <Container className={classes.modalStatus}>
                    <form action="" >
                        <div style={{ marginTop: "60px", marginLeft: "15%",direction:"ltr" }}>
                            <div>
