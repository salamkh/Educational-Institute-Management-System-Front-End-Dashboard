...
const ProfileWORLEAVE = () => {
    const classes = useStyles();
  
    const url = "http://127.0.0.1:8000/api/user_workLeave/";
    ...
    return (
        <Container className={classes.container}>
           ...
           <span style={{ color: "#333", fontSize: "25px" ,fontWeight:"500" }}>   استعراض المكافئات الخاصة بي    </span>
           </div>
...
export default ProfileWORLEAVE;