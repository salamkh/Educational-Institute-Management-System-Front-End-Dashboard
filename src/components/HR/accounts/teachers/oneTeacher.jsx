...
const OneTeacher = ({setTitle}) => {
    ...
    const url_subjects = "http://127.0.0.1:8000/api/teacherSubjects/" + id;
        ...
        axios.get(url_subjects, { headers: { authorization: "Bearer " + user.accessToken }, })
            .then(response => {
                if (isMounted) {
                    ...
                    data_subject = response.data.subjects;
                    console.log("data_subject", data_subject)
                            ...
                            <>
                                ...
                                <Grid container>
                                    <Grid item sm={2} xs={1} md={5} lg={5} style={{ marginLeft: "10px", }}>
                                        ...
                                        <div className="label_user_div" style={{ marginBottom: "12px" }} > <span style={{ color: "#384153", fontWeight: "600" }}> حالة الحساب</span></div>
                                    ...
                                    {exp &&
                                        <>
                                            <Grid item sm={2} xs={1} md={5} lg={5} style={{ marginLeft: "10px", }}>
                                                ...
                                                <div className="label_user_div" style={{ marginBottom: "12px" }} > <span style={{ color: "#384153", fontWeight: "600" }}> منح الشهادة </span></div>
                                                <div className={classes.sameItemConUser} style={{ width: "100%", margin: "auto", marginBottom: "20px", overflow: "wrap", padding: "1px" }} onClick={() => renderImg(one_user.user)}>
                                                    <div className="infoFeed" style={{ direction: "rtl", flexDirection: "column", overflowWrap: "break-word", marginRight: "10px", marginTop: "8px" }}>
                                                        <span>{exp.cerDate}</span>
                                                    </div>
                                                </div>
                                            ...
                                            <Grid item sm={2} xs={1} md={5} lg={5} style={{ marginLeft: "50px" }}>
                                                <div className="label_user_div" style={{ marginBottom: "12px" }}> <span className="label_user-left"> الشهادة   </span></div>
                                                <div className={classes.sameItemConUser} style={{ width: "100%", margin: "auto", marginBottom: "20px", overflow: "wrap", padding: "1px" }} onClick={() => renderImg(one_user.user)}>
                                                    <div className="infoFeed" style={{ direction: "rtl", flexDirection: "column", overflowWrap: "break-word", marginRight: "10px", marginTop: "8px" }}>
                                ...
                                <Grid container style={{ marginRight: "20px" }}>
                                    <Grid item sm={2} xs={1} md={5} lg={5}>
                                        ...
                                        <button className={classes.addButton} onClick={() => setOpenExp(true)}>الخبرات</button>

                                    </Grid>

                                    <Grid item sm={2} xs={1} md={5} lg={5} style={{ marginLeft: "40px" }}>

                                        <button className={classes.addButton} onClick={() => setOpenTime(true)}>أوقات الدوام</button>
                                    </Grid>
                ...
                <Container className={classes.modal}>
                    ...
                    {one_user && one_user.roles.length != 0 && one_user.roles.map((item) => (
                        <div className={classes.sameItemCon} style={{ width: "200px", marginBottom: "20px", overflow: "wrap", padding: "1px" }}>
                            ...
                            <div className="infoFeed" style={{ direction: "rtl", flexDirection: "column", overflowWrap: "break-word", marginRight: "10px", marginTop: "8px" }}>
                                <div style={{ marginRight: "10px", marginTop: "12px" }}>
                                    <span style={{ fontWeight: "500", fontSize: "20px" }}>{item.role}</span>
                                </div>
                ...
                <Container className={classes.modal}>
                    ...
                    <>
                        ...
                        <div style={{ marginBottom: "10px" }}>
                            <span style={{ color: "#6c8997", fontWeight: "600", fontSize: "25px" }}>الخبرات السابقة </span>
                        </div>
                        {exp &&
                            <>
                                <div className="expContainer">
                                    <div>
                                        <span style={{ color: "#333", fontWeight: "500", fontSize: "20px" }}>  {exp.experience} </span>
                                    </div>
                                </div>
