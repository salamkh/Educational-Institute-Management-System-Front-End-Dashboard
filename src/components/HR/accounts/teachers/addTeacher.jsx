...
const ADDTEACHER = ({ setTitle }) => {
    ...
    const add_user = "http://127.0.0.1:8000/api/addTeacher";
    ...
    const handleSubmit = (e) => {
        ...
        subject.forEach(item => formData.append('subjects[]', item));
            ...
            <Grid container style={{ direction: "rtl" }}>
                <Grid item md={3} lg={3}>
                    <Container className={classes.modal} style={{ marginTop: "20%" }}>
                        <Grid container>
                            <Grid item md={6} lg={6} style={{ marginTop: "5px" }}>
                    ...
                    <Container className={classes.modal} style={{ marginTop: "10%" }}>
                        <Grid container style={{ marginTop: "5px" }}>
                            <Grid item md={6} lg={6}>
                                <span style={{ color: "#6c8997", fontWeight: "500", fontSize: "20px" }}> المواد التي يستطيع تدريسها </span>
                            </Grid>
                            <Grid item md={6} lg={6}>
                ...
                <Grid item md={9} lg={9}>
                    <div className="containerAddTeacherAuto">
                        <Grid container >
                                ...
                                <>
                                    <Grid container style={{ direction: "rtl", marginRight: "5px" }}>
                                        ...
                                        <Grid item sm={2} xs={1} md={6} lg={6} style={{ direction: "rtl", marginTop: "30px" }}>
                                            ...
                                            <>
                                                <span style={{ color: "#333", fontSize: "20px", marginRight: "10px" }}>الشهادة</span><br />
                                        ...
                                        <Grid item sm={2} xs={1} md={6} lg={6} style={{ direction: "rtl", marginTop: "30px" }}>
                                            ...
                                            <>
                                                <span style={{ color: "#333", fontSize: "20px", marginRight: "10px" }}>تاريخ الشهادة</span><br />
                                        ...
                                        <Grid item sm={2} xs={1} md={6} lg={6} style={{ direction: "rtl", marginTop: "30px" }}>
                                            ...
                                            <>
                                                <span style={{ color: "#333", fontSize: "20px", marginRight: "10px" }}>الخبرات السابقة</span><br />
