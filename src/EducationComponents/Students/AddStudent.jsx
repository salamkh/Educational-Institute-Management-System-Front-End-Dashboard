...
export default function AddStudent({ setTitle }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const myStudent = {
            name, birthdate, phone, address, gender, myStatus, courseId, password
        };
        fetch(API_KEY + '/createStudent', {
            method: 'POST',
            ...
            response.json().then(response => {
                ...
                fetch('https://bms.syriatel.sy/API/SendSMS.aspx?job_name=marksJob&user_name=Altafawok1&password=tttt@2023&sender=Al-Tafawouk&msg=كلمة السر : ' + password + '&to=' + phone, {
                    method: 'POST',
                    mode: 'no-cors',
                })
            })
    ...
    return (
        <>
            <div className="test2" style={{ marginTop: "70px" }}>
                <h1 style={{ color: "rgba(39,116,218,0.5)" }}>إضافة طالب</h1>
